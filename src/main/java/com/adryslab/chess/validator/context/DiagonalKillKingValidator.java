...
@Singleton
public class DiagonalKillKingValidator extends AbstractKillKingValidator implements BiValidator<Cell, Cell[][], String>  {

    private static BiValidator<Cell, Cell[][], String> instance;

    // no construct allowed -> Singleton pattern
    private DiagonalKillKingValidator() {
    }
    ...
    static BiValidator<Cell, Cell[][], String> getInstance() {
        if(instance == null){
            synchronized (DiagonalKillKingValidator.class) {
                if(instance == null){
                    instance = new DiagonalKillKingValidator();
                }
            }
        }
        return instance;
